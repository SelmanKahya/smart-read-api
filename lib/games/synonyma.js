...
var createPoolWithoutWordLookup = function(callback){
    ...
    db.execute('SELECT word_lookup_word FROM word_lookup ORDER BY RAND() LIMIT 0 , 75', function(err, result){
...
var generateQuestionsFromPool = function(pool, level, count, callback){
    ...
    wordnik.getRandomWords(250, function(result, randomWords){
